...
## ----echo = TRUE---------------------------------------
azalea <- read.csv("https://unl-statistics.github.io/R-workshops/06-r-modeling/data/AzaleaOneWay.csv")
head(azalea)
...
## ----echo = TRUE---------------------------------------
azalea2 <- read.csv("https://unl-statistics.github.io/R-workshops/06-r-modeling/data/AzaleaTwoWay.csv")
...
## ----echo = TRUE---------------------------------------
azalea3 <- read.csv("https://unl-statistics.github.io/R-workshops/06-r-modeling/data/AzaleaBlock.csv")
