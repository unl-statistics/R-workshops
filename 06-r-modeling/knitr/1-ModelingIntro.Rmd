...
<br>
<br>
.small[*Content was modified from:* https://tjfisher19.github.io/introStatModeling/introductory-statistics-in-r.html#goals-of-a-statistical-analysis]
...
<br>
![](images/data-science-process.jpeg)
<br>
<br>
...
data(penguins, package = "palmerpenguins")
penguins[c(1:2,251:252,300:301),] %>% kable(format = 'html') %>% kable_styling("striped") %>% scroll_box(width = "100%")
```
...
```{r graphical-summaries, purl = F, echo = F, eval = T} 
penguins %>%
  ggplot(aes(x = sex, y = body_mass_g, color = sex, fill = sex)) +
  geom_boxplot(alpha = 0.5) +
  geom_point(position = "jitter", alpha = 0.7) + 
