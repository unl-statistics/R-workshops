...
---- | ---- | ----
9 - 9:45 | [Look at that!](knitr/1-GraphicsIntro.html) | basic plots: scatterplots, boxplots, histograms, barcharts and more <br/> some aesthetics: color, shape, ... <br/> [1-GraphicsIntro.R](code/1-GraphicsIntro.R)
9:45 - 10:30 | [Basics](knitr/2-Basics.html) | Why is data visualization important?. <br/> Data Types, Formats, and Structures <br/> Formatting your data: A tidy data discussion <br/> [2-Basics.R](code/2-Basics.R)
10:30 - 10:45 | **Break** |
10:45 - 12:00 | [Layers of Graphics](knitr/3-Layers.html) |  	More detailed look at the ggplot2 package: layers, geoms. <br/>[3-Layers.R](code/3-Layers.R)
12:00 - 1:00 | **Lunch Break (on your own)** | 
1:00 - 2:30 | [What do we see?](knitr/4-Perception.html) |  	Discussion of faceting and cognitive aspects of human perception. <br/>[4-Perception.R](code/4-Perception.R)
2:30 - 2:45 | **Break** |
2:45 - 3:50 | [Polishing your plots](knitr/5-PolishingPlots.html) |  	Finishing touches: options, themes. <br/>[5-PolishingPlots.R](code/5-PolishingPlots.R)
