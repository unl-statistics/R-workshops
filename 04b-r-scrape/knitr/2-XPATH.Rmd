...
## Your Turn Example (Using Weather Data)
...
```{r functiongetspeech, cache=TRUE, message = FALSE, warning = FALSE, size="huge"}
...
```{r textanalysis, warning = FALSE, message = FALSE, size="huge"}
...
## Longest speeches
- Let's determine the presidential speech is the longest.

```{r longestspeech, warning = FALSE, message = FALSE, size="huge"}
...
```{r speechplot, echo = FALSE, fig.align='center', cache = T, fig.height=5, fig.width=9.5, warning = FALSE, message = FALSE, size="huge"}
library(ggrepel)
