...
library(tidyverse)
curve <- read_csv("http://srvanderplas.github.io/rwrks/03-r-format/data/pitchdata.csv")
curve %>% 
...
library(tidyverse)
pitch <- read_csv("http://srvanderplas.github.io/rwrks/03-r-format/data/pitchdata.csv")
pitch %>% 
  filter(pitcher_hand == "R", pitch_type == "CU") %>% 
  head(3)
```
