...
midwest_names <- read_csv(
  "http://unl-statistics.github.io/R-workshops/03-r-format/data/midwest.csv", n_max= 2, 
  col_names = FALSE)
...
```{r}
# library(foreign)
# labdata <- read.xport("https://unl-statistics.github.io/R-workshops/03-r-format/data/AMDGDS_H.XPT")
#Your file path
# head(labdata)
```
...
pitch <- read_csv("https://unl-statistics.github.io/R-workshops/03-r-format/data/pitch.csv")
...
```{r, message=FALSE}
occupation <- read_csv("https://unl-statistics.github.io/R-workshops/03-r-format/data/occupation-1870.csv")
...
```{r, message=FALSE}
library(lubridate)
flights <- read.csv("http://unl-statistics.github.io/R-workshops/03-r-format/data/flights.csv")
...
billboard <- read.csv("http://unl-statistics.github.io/R-workshops/03-r-format/data/billboard.csv")
...
Voted <- left_join(Voted, People %>% select(playerID, nameFirst, nameLast), 
