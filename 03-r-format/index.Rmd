...
1:15 - 2:45 | [Tidy Data](knitr/3-tidyr.html) | Restructuring data with pivot wider, pivot longer, and separate. <br/>[3-tidyr.R](code/3-tidyr.R), [frenchfries.csv](data/frenchfries.csv), [billboard.csv](data/billboard.csv), [flights.csv](data/flights.csv)
2:45 - 3:00 | **Break** | 
