...
[resource](http://shiny.rstudio.com/gallery/widget-gallery.html)
...
**Note:** `Outputs` on the ui.R side work with `render` functions on the server.R side.
...
(Hint: see [Conditional Panel](https://shiny.rstudio.com/reference/shiny/1.6.0/conditionalPanel.html))
