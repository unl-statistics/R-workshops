...
- [Shiny Mailing List](https://groups.google.com/g/shiny-discuss)  
Check the tutorial first, then search the mailing list.

---
## Installing Shiny

+ Download and **extract** `apps.zip` from the R workshop webpage. *Make sure you know where you saved this!*
+ Create an R project for your `apps` folder.
...
```
<center>
<img src="images/HelloShinyScreenshot.png" alt="Picture of Hello Shiny! Applet" style="width:650px;">
</center>
