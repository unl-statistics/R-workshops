---
title: "![A Week of R at UNL](header.png)"
output: github_document
---

[Join our Google Group for updates and future course announcements](mailto:R-at-UNL+subscribe@googlegroups.com?Subject=subscribe-github)
...
<details><summary>Introduction to R</summary>
...
<details><summary>Graphics with <code>ggplot2</code></summary>
...
<details><summary>Dynamic Documents with <code>knitr</code> and <code>rmarkdown</code></summary>
...
If you are anticipating registering several people who are not UNL Affiliates as a group, please feel free to contact [Susan Vanderplas](mailto:svanderplas2@unl.edu?subject=R%20Workshops%20Pricing) for a group rate. 
...
- [Windows only] [Rtools](https://cloud.r-project.org/bin/windows/Rtools/)
